...
<style>
    :global(body) { color: #ccc; background: #222; font-family: monospace; }
    :global(img), :global(video), :global(svg) { max-width: 100%; height: auto; }
</style>

<!-- This file will be transformed by imgit on build. Markdown image
